...
if object_id(N'TableWithTrigger1', N'u') is not null
	drop table TableWithTrigger1
go

create table TableWithTrigger1
(
	id bigint not null constraint pkTableWithTrigger1 primary key,
...
if object_id(N'trTableWithTrigger1', N'tr') is not null
	drop trigger trTableWithTrigger1
go
