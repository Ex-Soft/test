...
insert into TableWithHierarchy (Id, ParentId, Val) values (201, null, N'Root')
insert into TableWithHierarchy (Id, ParentId, Val) values (202, 201, N'Level# 1')
insert into TableWithHierarchy (Id, ParentId, Val) values (203, 202, N'Level# 2')
insert into TableWithHierarchy (Id, ParentId, Val) values (204, 203, N'Level# 3')
