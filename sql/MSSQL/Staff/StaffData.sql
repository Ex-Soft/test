...
insert into Staff (Name, Salary, Dep, BirthDate, NullField) values (N'Кравчук Леонид Макарович', 333, 2, N'19340110', null)
insert into Staff (Name, Salary, Dep, BirthDate, NullField) values (N'Кучма Леонид Данилович', 444, 2, N'19380809', null)
insert into Staff (Name, Salary, Dep, BirthDate, NullField) values (N'Ющенко Виктор Андреевич', 111, 2, N'19540223', null)
insert into Staff (Name, Salary, Dep, BirthDate, NullField) values (N'Янукович Виктор Федорович', 555, 2, N'19500709', null)
...
insert into Staff (Name, Salary, Dep, BirthDate, NullField) values (N'Вашингтон Джордж', 8000, 5, N'17320222', null)
go