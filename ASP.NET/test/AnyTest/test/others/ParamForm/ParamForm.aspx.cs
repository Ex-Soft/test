...
namespace AnyTest
{
	...
	public class ParamForm : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
            ...
            ParagraphRequest.Text += "Supports EcmaScriptVersion = " + bc.EcmaScriptVersion + "<br>";
            ...
            ParagraphRequest.Text += "ScreenPixelsHeight = " + bc.ScreenPixelsHeight + "<br>";
            ParagraphRequest.Text += "ScreenPixelsWidth = " + bc.ScreenPixelsWidth + "<br>";
            ParagraphRequest.Text += "ScreenBitDepth = " + bc.ScreenBitDepth + "<br>";
			ParagraphRequest.Text+="<br>";
