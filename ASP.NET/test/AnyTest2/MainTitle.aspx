		...
		<form id="MainTitleForm" method="post" runat="server">
			<div align="center" nowrap style="color: blue">
				<h6 align="left" style="font-weight: normal; color: navy">
					...
					<asp:Label id="LabelDirectoryGetCurrentDirectory" runat="server" text="Directory.GetCurrentDirectory(): " style="font-weight: normal; color: black" /><br>
					<asp:Label id="LabelServerMapPath" runat="server" text="Server.MapPath(): " style="font-weight: normal; color: black" />
				</h6>
				<h1>AnyTest</h1>
