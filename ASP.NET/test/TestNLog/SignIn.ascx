<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SignIn.ascx.cs" Inherits="TestNLog.SignIn" %>
					...
					<td>
						<table cellspacing="1" cellpadding="0" width="200" align="center" border="0">
							<tr>
								...
								<td width="100%"><asp:TextBox id="TextBoxLogin" Text="login" runat="server" /></td>
							</tr>
							<tr>
