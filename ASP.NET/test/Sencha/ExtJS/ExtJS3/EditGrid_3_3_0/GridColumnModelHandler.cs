...
namespace EditGrid_3_3_0
{
	public class GridColumnModelHandler : IHttpHandler, IReadOnlySessionState
	{
		public void ProcessRequest(HttpContext context)
		{
			...
			RootJsonArray.Add(new JsonObject(new string[] { "id", "dataIndex", "type", "header", "width", "sortable", "align" }, new object[] { "ColCheckedEdit", "Checked", "boolean", "Checked", 75, true, "center" }));
			RootJsonArray.Add(new JsonObject(new string[] { "id", "dataIndex", "type", "header", "width", "sortable", "align" }, new object[] { "ColCheckedIIEdit", "Checked", "boolean", "CheckedII", 75, true, "center" }));
			RootJsonArray.Add(new JsonObject(new string[] { "id", "dataIndex", "type", "header", "width", "sortable", "align" }, new object[] { "ColCheckedIIIEdit", "Checked", "boolean", "CheckedIII", 75, true, "center" }));
