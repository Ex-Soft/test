...
{
	public class DataSourceHandler1 : IHttpHandler, IRequiresSessionState
	{
		const string
		...
		public void ProcessRequest(HttpContext context)
		{
			...
			if ((Cookie = context.Request.Cookies[MainForm.CookieName]) == null)
				Cookie = new HttpCookie(MainForm.CookieName);

			if (Cookie.Values["pageSize"] == null)
			{
				Cookie.Values["pageSize"] = "2";
