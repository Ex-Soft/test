...
namespace EditGridDynamically
{
	public class GridColumnModelHandler : IHttpHandler, IReadOnlySessionState
	{
		public void ProcessRequest(HttpContext context)
		{
			...
			RootJsonArray.Add(new JsonObject(new string[] { "id", "dataIndex", "type", "header", "width", "sortable", "align" }, new object[] { "ColCheckedIIEdit", "Checked", "boolean", "CheckedII", 50, true, "center" }));
			RootJsonArray.Add(new JsonObject(new string[] { "id", "dataIndex", "type", "header", "width", "sortable", "align" }, new object[] { "ColCheckedIIIEdit", "Checked", "boolean", "CheckedIII", 50, true, "center" }));
