<%@ Page language="c#" Codebehind="TestValidatorWSummaryForm.aspx.cs" AutoEventWireup="false" Inherits="AnyTest.TestValidatorWSummaryForm" %>
...
<HTML>
	...
	<body>
		<form id="TestValidatorWSummaryForm" method="post" runat="server">
