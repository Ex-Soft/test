...
namespace WebApi.Tests
{
    public class ValueControllerTests
    {
        ...
        [Fact]
        [Trait("UnitTestTarget", "ValueController")]
        public async void TestClass1()
        {
            ...
            // Act
            ValueController controller = CreateController();
        ...
        private ValueController CreateController()
        {
            return new ValueController(_mapper);
        }
    }
}
