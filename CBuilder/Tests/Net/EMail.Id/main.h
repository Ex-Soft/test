...
__published:	// IDE-managed Components
        ...
        void __fastcall IdLogDebugPOP3LogItem(TComponent *ASender, AnsiString &AText);
        void __fastcall IdLogDebugPOP3Connect(TObject *Sender);
        ...
        void __fastcall IdSMTPStatus(TObject *axSender,
          const TIdStatus axStatus, const AnsiString asStatusText);
        void __fastcall IdSMTPWork(TObject *Sender, TWorkMode AWorkMode,
          const int AWorkCount);
        void __fastcall IdSMTPWorkBegin(TObject *Sender,
          TWorkMode AWorkMode, const int AWorkCountMax);
        void __fastcall IdSMTPWorkEnd(TObject *Sender,
          TWorkMode AWorkMode);
