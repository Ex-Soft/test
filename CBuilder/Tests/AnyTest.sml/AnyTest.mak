...
# ---------------------------------------------------------------------------
PROJECT = AnyTest.exe
OBJFILES = obj\AnyTest.obj obj\main.obj
RESFILES = AnyTest.res
MAINSOURCE = AnyTest.cpp
...
PACKAGES = vcl.bpi rtl.bpi dbrtl.bpi adortl.bpi vcldb.bpi vclx.bpi bdertl.bpi \
    ...
    dsnapcrba.bpi dsnapcon.bpi vclie.bpi xmlrtl.bpi inet.bpi inetdbbde.bpi \
...
PATHOBJ = .;$(LIBPATH)
# ---------------------------------------------------------------------------
CFLAG1 = -Od -H=obj\csm.csm -Hc -Q -Vx -Ve -X- -r- -a8 -b -k -y -v -vi- -c -tW -tWM
IDLCFLAGS = -src_suffix cpp -D_DEBUG -I$(BCB)\include -I$(BCB)\include\vcl -boa
