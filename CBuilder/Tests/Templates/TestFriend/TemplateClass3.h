...
public:
    ...
    template <typename T> friend std::ostream& operator << (std::ostream& os, const TemplateClass3<T>&); // E2335 Overloaded 'operator ostream & << <int>(ostream &,const TemplateClass3<int> &)' ambiguous in this context
};
