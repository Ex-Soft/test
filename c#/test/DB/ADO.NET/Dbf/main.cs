        ...
        public static string CP1251ToCP866(string aInpStr)
        {
            ...
            for (int i = 0; i < asciiBytes.Length; ++i)
            {
                switch (asciiBytes[i])
                {
                    case 0x0a5:
                        {
                            asciiBytes[i] = 0x0c3; // 0x0a5 (165) -> 0x0c3 (195) Ґ -> Г
                            break;
                        }
                    case 0x0b4:
                        {
                            asciiBytes[i] = 0x0e3; // 0x0b4 (180) -> 0x0e3 (227) ґ -> г
                            break;
                        }
                    case 0x0b2:
                        {
                            asciiBytes[i] = 0x049; // 0x0b2 (178) -> 0x049 (73) І -> LATIN LETTER I
                            break;
                        }
                    case 0x0b3:
                        {
                            asciiBytes[i] = 0x069; // 0x0b3 (179) -> 0x069 (105) і -> LATIN LETTER i
                            break;
                        }
                }
            }
