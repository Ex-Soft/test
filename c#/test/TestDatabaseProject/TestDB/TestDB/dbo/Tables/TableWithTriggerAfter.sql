CREATE TABLE [dbo].[TableWithTriggerAfter] (
    [id]    BIGINT         NOT NULL,
    [value] NVARCHAR (256) NULL,
    CONSTRAINT [pkTableWithTriggerAfter] PRIMARY KEY CLUSTERED ([id] ASC)
);
...
begin
	...
	insert into TableWithTriggerAfterStub (id, value) values (1, N'1')
end
