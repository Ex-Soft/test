		...
		static void Main(string[] args)
		{
			...
			try
			{
				try
				{
					...
					tmpString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Directory.GetCurrentDirectory() + "\\..\\..\\med.xls" + ";Extended Properties=\"Excel 12.0 Xml;HDR=No;MAXSCANROWS=0;IMEX=1\"";
