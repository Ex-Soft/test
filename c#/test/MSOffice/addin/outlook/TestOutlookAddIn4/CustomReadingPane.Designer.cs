namespace TestOutlookAddIn4
{
    ...
    partial class CustomReadingPane : Microsoft.Office.Tools.Outlook.FormRegionControl
    {
        public CustomReadingPane(Microsoft.Office.Interop.Outlook.FormRegion formRegion)
            : base(formRegion)
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "CustomReadingPane";
            this.Size = new System.Drawing.Size(459, 150);
            this.FormRegionClosed += new System.EventHandler(this.CustomReadingPane_FormRegionClosed);
            this.FormRegionShowing += new System.EventHandler(this.CustomReadingPane_FormRegionShowing);
        ...
        public partial class CustomReadingPaneFactory : Microsoft.Office.Tools.Outlook.IFormRegionFactory
        {
            ...
            {
                CustomReadingPane form = new CustomReadingPane(formRegion);
                form.Factory = this;
                return form;
            }
    ...
    {
        internal CustomReadingPane CustomReadingPane
        {
            get
            {
                return this.FindFirst<CustomReadingPane>();
            }
        }
    }
}
