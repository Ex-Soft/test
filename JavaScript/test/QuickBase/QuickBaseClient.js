     ...
     this.APIXMLPost = function(dbid, action, xmlQDBRequest)
        {
            ...
            xmlHTTPPost.setRequestHeader("Access-Control-Allow-Origin", "http://localhost"); // Added!!!
            xmlHTTPPost.setRequestHeader("Access-Control-Allow-Methods", "POST, GET, OPTIONS"); // Added!!!
            xmlHTTPPost.setRequestHeader("Access-Control-Allow-Headers", "Content-Type"); // Added!!!
            try
            {
