//Ext.Loader.setPath("Ext.ux", "../../../../../../../ExtJS/ExtJS4/ExtJS4.2.0/examples/ux");

Ext.Loader.setConfig({
	enabled: true,
	disableCaching: false,
	paths: {
		"Ext.ux": "../../../../../../../ExtJS/ExtJS4/ExtJS4.2.0/examples/ux"
	}
});
	...
	var
		...
		store = Ext.create("Ext.data.ArrayStore", {
			...
			proxy: {
				...
				//, data: data // needs store.load() || store.loadPage()
			}
			...
			dockedItems: [{
					...
					pageSizeValue,
				{
					...
					handler: function(btn, e) {
						...
						var
							grid = this.up("grid"),
							p = grid.getDockedItems("pagingtoolbar[dock=\"bottom\"]");

						if(Ext.isArray(p) && p.length>0)
							p[0].doRefresh();
					}
				}]
			}, {
