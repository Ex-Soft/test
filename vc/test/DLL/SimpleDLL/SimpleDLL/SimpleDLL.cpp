...
BOOL WINAPI SetHook(DWORD dwThreadId, HWND hWnd) {
	...
	if (dwThreadId != 0) {
		...
		g_hhook = SetWindowsHookEx(/*WH_GETMESSAGE*/ WH_MOUSE, GetMsgProc, g_hinstDll, /*dwThreadId*/ 0);
